    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('povprecna_cd_zeho_h', models.FloatField()),
                ('povprecna_cd_hitro', models.FloatField()),
                ('povprecna_cd_redno', models.FloatField()),
                ...
                ('st_cakajocih_zeho_h', models.FloatField(blank=True, null=True)),
                ...
                ('nad_dop_cd_zeho_h', models.FloatField(blank=True, null=True)),
